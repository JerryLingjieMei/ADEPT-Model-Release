...
echo 'output/default_detection/ADEPT-detection-0050000.pth' > output/default_detection/last_checkpoint
...
echo 'output/default_derender/ADEPT-derender-0050000.pth' > output/default_derender/last_checkpoint
